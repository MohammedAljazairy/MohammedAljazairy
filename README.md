# Mohammed Aljazairy — Unity Game Developer

> Computer Engineering graduate · ITI Game Programming Diploma (2026) · Cairo, Egypt

---

## 👾 About Me

I'm a **Unity game developer** with a passion for crafting immersive gameplay experiences — from faithful retro remakes to first-person horror and physics-based racing. Currently completing a 9-month Professional Diploma in Game Programming at the **Information Technology Institute (ITI)**, where I'm deepening my expertise in Unity and game systems architecture.

My core focus is **Unity (2D & 3D)** with C#, covering everything from gameplay mechanics and physics tuning to level design and enemy AI. I've shipped multiple prototypes and game jam entries, and I'm always building.
...
|---|---|
| **Game Engines** | Unity (primary), Unreal Engine 5 |
| **Languages** | C# · C++ · C · Java · Python · R · Assembly |
| **Unity Skills** | 2D/3D GameKit · Physics (WheelColliders, Rigidbody) · WheelColliders · Enemy AI · Level Design |
| **Other Frameworks** | SFML · Box2D |
| **AI / ML** | Python · NLP · Whisper · CNN |
| **Systems** | Assembly (x86/ARM) · Microprocessors · Embedded |
| **Data** | SQL · R · Big Data analysis |
...
- **9-Month Professional Diploma — Game Programming**, ITI Smart Village *(2025–2026)*
- **B.Sc. Computer Engineering**, AAST Cairo *(2020–2025)*
- Unreal Engine 5: Complete Beginners Course — Udemy *(Mar 2026)*
- The Art of Level Design — Udemy *(Mar 2026)*
- Agile & Scrum Fundamentals — Udemy *(May 2026)*
- Git & GitHub — Almadrsa *(Nov 2025)*
- ICTHub AI Training — Python & NLP chatbot *(2024)*
